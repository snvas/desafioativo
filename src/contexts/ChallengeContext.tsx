...
interface ChallengesContextData {
    level: number;
    currentExperience: number;
    expererienceToNextLevel: number;
    challengesCompleted: number;
...
export function ChallengesProvider({
    ...
    const expererienceToNextLevel = Math.pow((level + 1) * 4, 2)
    ...
    function completeChallenge() {
        ...
        if (finalExperience >= expererienceToNextLevel) {
            finalExperience = finalExperience - expererienceToNextLevel;
            levelUp();
        }
